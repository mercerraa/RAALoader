...
class RAAloader:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&RAÄ loader')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('RAAloader', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/raa_loader/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Download RAÄ data'),
            callback=self.run,
